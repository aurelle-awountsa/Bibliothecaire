        ...
        def check():
            try:
                ...
                if not z:
                    ...
                    #label and input box
                    self.label3 = Label(self, text='Bienvenue sur Bibliothécaire', fg= 'light blue',bg='dark grey', font=('Algerian', 45, 'bold'))
                    self.label3.place(x=290, y=80)
                    self.label4 = Label(self, text="Entret l'id étudiant", bg='dark grey', font=('Arial', 20, 'bold'))
                    ...
                    self.label5 = Label(self, text='OU', bg='dark grey', font=('arial', 16, 'bold')).place(x=170, y=235)
                    self.label5 = Label(self, text="Entrer l'id du livre", bg='dark grey', font=('Arial', 20, 'bold'))
